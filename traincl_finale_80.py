...
class MusicTransformerTrainer:
    ...
    def __init__(self, hparams_, batch_size, total_epochs, warmup_steps=4000, ckpt_path="sortedsequence/cl/experiment15.pt", 
        ...
        log_dir = "logs/cl_experiment_large_15_80"
    ...
    def calculate_curriculum_percent(self, total_batches):
        ...
        phase2_end = int(0.8 * self.TARGET_BATCHES)  # End linear increase at 80% of target
    ...
    def fit(self, epochs):
        ...
        print("- Linear growth phase: 0% to 80% of target batches")
        print("- Full dataset phase: 80% to 100% of target batches\n")
